package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1052:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_599:uint = 0;
      
      public static const const_892:String = "AssetLibraryReady";
      
      public static const const_1331:String = "AssetLibraryUnloaded";
      
      public static const const_412:String = "AssetLibraryLoaded";
      
      public static const const_1300:String = "AssetLibraryLoadError";
       
      
      private var var_519:XML;
      ...
      private var var_520:Boolean = true;
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_519 = _loc2_.manifest.copy();
         var_358 = _loc2_.resource;
         if(var_520)
         {
            AssetLibrary.fetchLibraryContents(this,var_519,var_358);
         }
         var_315 = true;
         dispatchEvent(new Event(AssetLibrary.const_412));
         dispatchEvent(new Event(AssetLibrary.const_892));
         if(var_520)
         {
            var_15.dispose();
            var_15 = null;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1052.splice(var_1052.indexOf(this),1);
            --var_599;
            var_422 = null;
            var_724 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1300));
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_519.child("library");
         if(_loc2_ == null)
         {
