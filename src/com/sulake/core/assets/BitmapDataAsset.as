   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_1099 = BitmapDataAsset(param1).var_1099;
            var_1098 = BitmapDataAsset(param1).var_1098;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1099 = _loc4_ == "1" || _loc4_ == "PetVisualizationData";
                  break;
               case "flipV":
                  var_1098 = _loc4_ == "1" || _loc4_ == "PetVisualizationData";
                  break;
            }
            _loc2_++;
         }
