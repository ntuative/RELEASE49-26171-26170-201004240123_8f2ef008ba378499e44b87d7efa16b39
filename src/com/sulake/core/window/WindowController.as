package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1525:Point = new Point();
      ...
      protected var var_643:Function;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_133,WindowParam.const_145);
         var _loc2_:* = !testParamFlag(WindowParam.const_117,WindowParam.const_149);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_328)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_640 = param1;
         var_545 = !!var_640 ? uint(var_545 | var_1389) : uint(var_545 & 16777215);
      ...
      {
         var_546 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2044 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1010:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1336:
               _loc2_ = "null";
               _loc4_ = true;
               break;
         ...
         if(_loc2_ == WindowEvent.const_183)
         {
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_608,var_8);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_826);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_294,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_546);
      }
      
      public function set color(param1:uint) : void
      {
         var_1389 = param1 & 4278190080;
         var_545 = !!var_640 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_76);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_843;
               ...
               case MouseEvent.MOUSE_UP:
                  if(method_1(WindowState.const_101))
                  {
               ...
               case MouseEvent.MOUSE_OUT:
                  if(method_1(WindowState.const_82))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_173:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_379,this,null));
                     if(testParamFlag(WindowParam.const_169,WindowParam.const_145))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_175,WindowParam.const_149))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_240,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_423:
                  var_16.invalidate(this,var_8.union(var_56),WindowRedrawFlag.const_451);
                  if(param1 == this)
                  {
               ...
               case WindowNotifyEvent.const_319:
                  if(param1 == this)
                  {
                     ...
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_200,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_368:
               ...
               case WindowNotifyEvent.const_415:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_451);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_200:
                  ...
                  break;
               case WindowNotifyEvent.const_379:
                  var_9.getRegionProperties(null,var_311);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_294:
      ...
      {
         return var_643 != null ? var_643 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_899;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_546);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_523,this,param1));
         return param1;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_380)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_535,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
         ...
         if(var_162 && var_546 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1525,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1525,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_311 = var_9.rectangle.clone();
               var_56.x = var_8.x;
               var_56.y = var_8.y;
               var_56.width = var_8.width;
               var_56.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_377,this,var_9));
            }
            else
            {
               var_311.x = 0;
               ...
               var_311.width = 0;
               var_311.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_979,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,_param,var_16,var_8,null,var_643,properties,var_639.concat(),_id) as WindowController;
      ...
      {
         if(var_33 == WindowState.const_414)
         {
            return true;
         }
         var_33 = WindowState.const_414;
