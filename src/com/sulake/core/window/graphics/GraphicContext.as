package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_383:uint = 0;
      ...
      public static const const_743:uint = 4;
      
      public static const const_1305:uint = 0;
      
      public static const const_1159:uint = 16;
      
      public static const const_608:uint = 1;
      
      public static const const_1163:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_638:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1159:
               ...
               break;
            case GraphicContext.const_743:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_853:
               break;
            case GraphicContext.const_1305:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_638)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_383 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_638)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_383 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1612,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1612,16777215);
                  }
                  var_383 += bitmap.width * bitmap.height * 4;
               }
