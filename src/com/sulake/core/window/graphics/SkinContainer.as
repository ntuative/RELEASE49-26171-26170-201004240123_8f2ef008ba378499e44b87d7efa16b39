package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_766:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1466,var_1872);
         var_1206 = new Dictionary();
         var_1873 = new Dictionary();
         StateCodeTable.fillTables(var_1206,var_1873);
         ...
         {
            var_384 = new Array();
            var_384.push(WindowState.const_66);
            var_384.push(WindowState.const_73);
            var_384.push(WindowState.const_101);
            ...
            var_384.push(WindowState.const_90);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1206)
         {
            _loc3_.push(var_1206[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "PetVisualizationData" : false;
                  ...
                  addSkinRenderer(var_1466[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_684[param1];
      ...
      {
         var _loc3_:Array = var_683[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_683[param1] = new Array(SkinContainer.const_766);
         }
         var_683[param1][param2] = param3;
         if(true)
         {
            var_684[param1] = new Array(SkinContainer.const_766);
         }
         var_684[param1][param2] = param4;
      }
