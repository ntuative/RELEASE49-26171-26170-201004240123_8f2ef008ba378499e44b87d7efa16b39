package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_607.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_576,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_319[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1561,var_1560))
            {
               if(param2.render(param1,var_1561,var_1560))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_681);
            var_319[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_576,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_320,WindowRedrawFlag.const_249);
            if(var_607.indexOf(param1) == -1)
            {
               var_607.push(param1);
            }
         }
