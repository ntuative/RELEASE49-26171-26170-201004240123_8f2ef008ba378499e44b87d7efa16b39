package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_645:Dictionary;
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_645[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_487)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_487)
                  {
                     _loc15_ = true;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc2_ = var_645[_loc1_] as BitmapData;
            _loc2_.dispose();
