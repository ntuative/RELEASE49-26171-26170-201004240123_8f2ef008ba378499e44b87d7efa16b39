package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1451:String = "_INCLUDE";
      
      public static const const_1003:String = "_EXCLUDE";
      
      public static const const_1514:String = "_TEMP";
      
      private static const const_1062:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1393:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_953,var_1393);
         var_1392 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1062,"");
      }
      
      private function method_4(param1:XML) : Array
      {
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_953)
            {
               delete var_953[_loc1_];
            }
            for(_loc1_ in var_1393)
            {
               delete var_1393[_loc1_];
            }
            var_1392.dispose();
            var_1392 = null;
            var_16 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "PetVisualizationData";
         ...
         window = var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,method_4(xml.child("variables")[0]),tags) as WindowController;
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "PetVisualizationData";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "PetVisualizationData";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1003) == -1)
                  {
