package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_756:String = "margin_top";
      
      private static const const_1043:String = "_HEADER";
      
      private static const const_754:String = "margin_right";
      
      private static const const_1042:String = "_SCALER";
      
      private static const const_1040:String = "_TITLE";
      
      private static const const_1041:String = "_CONTENT";
      
      private static const const_753:String = "margin_left";
      
      private static const const_755:String = "margin_bottom";
      ...
      private var var_1134:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_753,_loc3_.left,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_756,_loc3_.top,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_754,0 - _loc3_.right,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_755,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1134 == null)
         {
            var_1134 = findChildByTag(const_1043) as IHeaderWindow;
            if(!var_1134)
            {
      ...
      {
         return findChildByTag(const_1042) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_272,false);
         }
      ...
      {
         return content != null && var_1398 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1041) as IWindowContainer;
            if(!var_20)
            {
