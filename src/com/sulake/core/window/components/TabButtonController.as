package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1432:String = "TAB_BUTTON_ICON";
      
      private static const const_1431:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1087:String = "TAB_BUTTON_TITLE";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1087));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
