package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1071:String = "content";
      
      private static const const_1072:String = "selector";
       
      
      private var var_1350:Boolean = false;
      
      protected var var_954:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1613 == null)
         {
            var_1613 = findChildByTag(TabContextController.const_1071) as IWindowContainer;
         }
         return var_1613;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_954 == null)
         {
            var_954 = findChildByTag(TabContextController.const_1072) as ITabSelectorWindow;
            if(var_954 != null)
            {
               var_954.procedure = selectorEventProc;
            }
         }
         return var_954;
      }
