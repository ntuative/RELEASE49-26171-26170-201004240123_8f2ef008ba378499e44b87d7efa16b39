package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2357:Rectangle = new Rectangle();
      ...
      protected var var_547:String = "none";
      ...
      {
         return new Rectangle(var_641 * maxScrollH,var_378 * maxScrollV,width,height);
      }
      ...
      {
         var_641 = param1;
         _field.scrollH = var_641 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_641,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_641,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_60,true));
         _loc1_.push(new PropertyStruct("margin_left",var_67.left,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_top",var_67.top,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_right",var_67.right,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_67.bottom,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("auto_size",var_547,PropertyStruct.STRING,var_547 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_641,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_547 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_547 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_547 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_547 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
