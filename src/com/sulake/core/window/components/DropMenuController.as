package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_123:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_123 == null || false)
         {
            var_123 = context.create(name + "::submenu","",WindowType.const_432,var_79,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_123.setGlobalRectangle(_loc1_);
         }
         var_123.activate();
         return var_123;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_94)
         {
            ...
            {
               if(param2.method_1(WindowState.const_82))
               {
         ...
         else if(param1.type == WindowEvent.const_901)
         {
            if(param2 == var_123)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_418,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_309,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_123 != null)
            {
               _loc2_ = var_123.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
