package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_339:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.method_1(WindowState.const_73))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_339)
         {
            var_339 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_339)
            {
               var_339.addEventListener(WindowEvent.const_250,scrollBarEventProc);
               var_339.addEventListener(WindowEvent.const_204,scrollBarEventProc);
            }
         }
         return var_339;
      }
      ...
      override public function dispose() : void
      {
         if(var_339)
         {
            var_339.removeEventListener(WindowEvent.const_250,scrollBarEventProc);
            var_339.removeEventListener(WindowEvent.const_204,scrollBarEventProc);
            var_339 = null;
         }
         if(var_820)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_204)
         {
            hideScrollBar();
         }
      }
