package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
            ...
            if(var_9)
            {
               if(!(var_9 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_200,this,null));
                        break;
                     }
      ...
      {
         return method_1(WindowState.WINDOW_STATE_SELECTED);
      }
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_616;
         update(this,_loc1_);
         return true;
      }
   }
