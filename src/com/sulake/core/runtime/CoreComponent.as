package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1094:String = "service-libraries";
      
      private static const const_1092:String = "library";
      
      private static const const_1093:String = "component-libraries";
      ...
      private var var_312:uint;
      
      private var var_1037:IEventDispatcher;
      
      private var var_871:Profiler;
      ...
      private var var_713:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1286:
               ...
               var_871 = new Profiler(this);
               attachComponent(var_871,[new IIDProfiler()]);
               var_713 = new ProfilerViewer();
               var_214.addChild(var_713);
               break;
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_1037)
         {
            ...
            var_1037.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,param1.bytesLoaded,param1.bytesTotal));
         }
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return var_312 - getNumberOfFilesPending();
      }
      ...
      private function profilerFrameUpdateHandler(param1:Event) : void
      {
         ...
         {
            var_595[criticality] = 0;
            receivers = var_513[criticality];
            index = 0;
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_871.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_1037)
         {
            var_1037.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_137)
         {
            ...
            {
               if(var_595[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_137)
            {
               _loc2_ = var_513[_loc3_] as Array;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1227);
         if(!_isDisposed)
         {
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_513[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         while(_loc4_ < CoreComponent.const_137)
         {
            _loc3_ = var_513[_loc4_] as Array;
