package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1602:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_947 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_947);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1118 & const_848)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_452 + "]";
      }
