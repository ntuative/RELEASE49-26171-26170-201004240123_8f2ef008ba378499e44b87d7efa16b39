package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1359:IConnectionStateListener;
      ...
      {
         if(param1 == null || var_448 == null)
         {
            return null;
         }
         return var_448[param1] as IConnection;
      }
      ...
      {
         var _loc2_:Class = var_769[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_448)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_886:
               _loc3_ = new SocketConnection(param1,this,var_1359);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_448[param1] = _loc3_;
         return _loc3_;
      }
