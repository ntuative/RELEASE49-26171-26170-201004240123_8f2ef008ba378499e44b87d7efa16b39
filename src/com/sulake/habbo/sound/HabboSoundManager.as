package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManager extends Component implements IHabboSoundManager
   {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _roomEngine.events.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_842,onPlayEvent);
      }
      ...
      private function storeVolumeSetting() : void
      {
         if(_connection != null)
         {
            _connection.send(new SetSoundSettingsComposer(int(var_680 * 100)));
         }
      }
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1174:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1016:
