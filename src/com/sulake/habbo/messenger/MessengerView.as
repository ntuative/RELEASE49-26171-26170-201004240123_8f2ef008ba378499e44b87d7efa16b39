package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_795:ConversationsTabView;
      ...
      private var var_707:ITextFieldWindow;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_707.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_707.text = "";
         var_125.conversations.addMessageAndUpdateView(new Message(Message.const_646,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_14 == null)
         {
            prepareContent();
            refresh(true);
            var_125.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MESSENGER,var_14));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_795 == null ? 7 : int(this.var_795.getTabCount());
      }
      ...
      {
         var_14 = IFrameWindow(var_125.getXmlWindow("main_window"));
         ...
         var_795 = new ConversationsTabView(var_125,var_14);
         var_795.refresh();
         var_707 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_707.addEventListener(WindowKeyboardEvent.const_143,onMessageInput);
         var_1163 = new ConversationView(var_125,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_526,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_1022,true);
      }
   }
}
