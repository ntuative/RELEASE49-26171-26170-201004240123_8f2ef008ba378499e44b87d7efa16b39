package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1108:int = 20;
      
      private static const const_784:int = 100;
       
      
      private var var_2108:IScrollbarWindow;
      
      private var var_125:HabboMessenger;
      
      private var var_1552:IContainerButtonWindow;
      
      private var var_528:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_125 = param1;
         var_1552 = initButton("follow_friend",onFollowButtonClick,param2);
         var_49 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2108 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_646 || param3.type == Message.const_680 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_528.messages.length - const_784);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_528.messages.length)
         {
            refreshEntry(true,_loc1_,var_528.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_528 == null || _loc1_.id != var_528.id)
         {
            var_528 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_784 + const_1108)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_125.send(new FollowFriendMessageComposer(var_528.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1109;
         param1.invalidate();
      }
   }
}
