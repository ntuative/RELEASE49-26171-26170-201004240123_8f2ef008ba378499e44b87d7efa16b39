package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_308:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_997,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_593.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_593.setSelected(_loc2_);
            var_308.openMessenger();
            var_308.refresh(true);
         }
      }
      ...
      {
         var_593.addMessageAndUpdateView(param1);
         if(!var_308.isMessengerOpen())
         {
      ...
      {
         var_593 = new Conversations(new ConversationsDeps(this));
         var_308 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_593.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_680,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_593.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_801,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_593.addMessageAndUpdateView(_loc3_);
      }
