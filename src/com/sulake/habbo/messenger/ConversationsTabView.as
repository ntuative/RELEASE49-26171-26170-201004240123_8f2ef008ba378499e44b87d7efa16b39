package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_808 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_178 ? var_125.conversations.findConversation(param2.id) : var_125.conversations.openConversations[_loc3_ + var_125.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = param1.getChildByName(HabboMessenger.const_178) as IBitmapWrapperWindow;
      ...
      {
         var _loc3_:IWindowContainer = var_808.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
