package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_426.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_426.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_426.removeStopEventListener(refresh);
            var_426 = null;
            _windowManager = null;
            var_761 = null;
            _disposed = true;
