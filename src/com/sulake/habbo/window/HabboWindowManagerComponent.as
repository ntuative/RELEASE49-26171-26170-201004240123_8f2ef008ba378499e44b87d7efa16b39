package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1337:IEventDispatcher;
      
      private var var_2401:uint = 0;
      
      private var var_1336:ProfilerAgentTask;
      
      private var var_1335:ProfilerOutput;
      
      private var var_761:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1337 = Component(param1).events;
         var_441 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_681 = new SkinContainer(_loc3_.content as XML,assets);
         var_761 = new WindowRenderer(var_681);
         var_239 = new Array(const_354);
         var _loc5_:int = 0;
         while(_loc5_ < const_354)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_761,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_239[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_239[const_1131];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_322,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1211,_loc6_);
      }
      ...
      {
         return var_239[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_441[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_441[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1335 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1335 = new ProfilerOutput(_loc3_,this,var_761);
               var_1334 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1334);
               var_1336 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1336);
               var_1082 = true;
            }
         }
      }
      ...
      {
         return var_681.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_943.length > 0)
         {
            var_1337.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_354 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1337.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_943.length > 0)
         {
            WindowContext.var_943.flush();
         }
         if(WindowContext.var_1380.length > 0)
         {
            WindowContext.var_1380.flush();
         }
         var_1337.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1276,new Date().getTime().toString());
