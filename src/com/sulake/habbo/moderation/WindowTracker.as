package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1193:int = 7;
      
      public static const const_972:int = 3;
      
      public static const const_1354:int = 8;
      
      public static const const_981:int = 5;
      ...
      {
         var _loc2_:Dictionary = var_1524[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1524[param1] = _loc2_;
         }
         return _loc2_;
      }
