package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_686:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_827 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_826 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_828.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1208,var_403.text,getBanLength(),var_1209));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_828.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1208,var_403.text,var_1209));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_687 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1208,var_403.text,var_1209));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            var_54.findChildByName("offence_txt").caption = this.var_686.name;
            var_54.findChildByName("offence_category").visible = true;
         }
         else if(this.var_687 != null)
         {
            this.refreshButtons("offences_cont",2,var_687.offences,var_827,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_826,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_686 = var_687.offences[_loc3_];
         var_403.text = var_686.msg;
         var_317 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_54.caption = "Mod action on: " + var_1475;
         ...
         var_828 = IDropMenuWindow(var_54.findChildByName("banLengthSelect"));
         prepareBanSelect(var_828);
