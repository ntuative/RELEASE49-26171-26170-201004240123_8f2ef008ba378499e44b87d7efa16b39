package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1636:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1638:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1410:IIssueBrowserView;
      
      private const const_1665:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1637:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_215:ITabContextWindow;
      
      private var var_1412:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_336.view.width = var_215.container.width;
         var_336.view.height = var_215.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1637:
               if(var_1410 == null)
               {
                  var_1410 = new MyIssuesView(issueManager,this,var_215.container);
               }
               return var_1410;
            case const_1636:
               if(var_1411 == null)
               {
                  var_1411 = new OpenIssuesView(issueManager,this,var_215.container);
               }
               return var_1411;
            case const_1638:
               if(var_1412 == null)
               {
                  var_1412 = new PickedIssuesView(issueManager,this,var_215.container);
               }
               return var_1412;
            default:
               return null;
