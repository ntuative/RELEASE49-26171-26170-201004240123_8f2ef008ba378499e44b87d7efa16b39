package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1855:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1853:WindowTracker;
      ...
      private var var_1854:ModerationMessageHandler;
      
      private var var_674:StartPanelCtrl;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_674 = new StartPanelCtrl(this);
         var_1853 = new WindowTracker();
      }
      
      public function userSelected(param1:int, param2:String) : void
      {
         Logger.log("USER SELECTED: " + param1 + ", " + param2);
         this.var_674.userSelected(param1,param2);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1854 = new ModerationMessageHandler(this);
         }
      }
