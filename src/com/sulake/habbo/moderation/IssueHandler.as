package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_401 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_990 = new UserInfoCtrl(_window,var_57,_loc3_.message);
         var_401.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_107.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_990.load(_loc4_,var_107.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_57.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_57,WindowTracker.const_972,_loc2_),_window,false,false,true);
      }
      ...
      {
         return WindowTracker.const_1354;
      }
   }
}
