package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1013:String = "issue_bundle_open";
      
      public static const const_564:String = "issue_bundle_my";
      
      public static const const_1027:String = "issue_bundle_picked";
      ...
      private var var_564:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_122 = new Map();
         var_787 = new Map();
         var_564 = new IssueBrowser(this,var_57.windowManager,var_57.assets);
         var_652 = [];
         var_786 = [];
         var_965 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_965.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:IssueBundle = var_122.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
         sendPick(_loc2_.getIssueIds());
         var_652 = var_652.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(_loc2_ != 0)
         {
            _loc3_ = var_122.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
         ...
         if(_loc3_ == null)
         {
            ...
            var_122.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(var_652.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_140)
         {
            _loc5_ = getBundles(const_564);
            _loc6_ = false;
            ...
            _loc8_ = var_786.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_965.remove(param1);
         var_965.add(param1,_loc3_);
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_786 = var_786.concat(param1);
      }
      
      public function closeBundle(param1:int, param2:int) : void
      {
         var _loc3_:IssueBundle = var_122.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:* = var_965.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = var_122.getValues();
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_564 == null || !var_564.isOpen())
         {
            var_57.soundManager.playSound(HabboSoundTypesEnum.const_808);
         }
      }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = var_122.getValues();
