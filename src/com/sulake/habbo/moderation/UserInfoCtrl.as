package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_771:int = 31536000;
      
      private static const const_773:int = 86400;
      
      private static const const_774:int = 3600;
      
      private static const const_772:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_772) + " mins ago";
         }
         if(param1 < 2 * const_773)
         {
            return Math.round(param1 / const_774) + " hours ago";
         }
         if(param1 < 2 * const_771)
         {
            return Math.round(param1 / const_773) + " days ago";
         }
         return Math.round(param1 / const_771) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_981,_data.userId),_callerFrame,var_1034,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_870.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_870.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1209),_callerFrame,var_1034,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1034,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1209),_callerFrame,var_1034,false,true);
      }
