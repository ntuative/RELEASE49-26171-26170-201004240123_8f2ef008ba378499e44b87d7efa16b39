package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_805 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_806 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1526);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_805.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_806.clone());
         _loc4_.color = var_1177[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
