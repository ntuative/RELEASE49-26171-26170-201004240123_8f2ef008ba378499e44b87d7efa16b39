package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_755:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_712,_data.flatId),var_54,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_443);
         if(param1.flatId != var_443)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_443);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_755.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1234,_loc2_,var_403.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1079.isSelected,var_1080.isSelected,var_755.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1296);
      }
      ...
      public function populate() : void
      {
         ...
         var_755 = ICheckBoxWindow(var_54.findChildByName("kick_check"));
         var_1079 = ICheckBoxWindow(var_54.findChildByName("lock_check"));
         var_1080 = ICheckBoxWindow(var_54.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_443));
         Logger.log("BEGINNING TO SHOW: " + var_443);
      }
   }
}
