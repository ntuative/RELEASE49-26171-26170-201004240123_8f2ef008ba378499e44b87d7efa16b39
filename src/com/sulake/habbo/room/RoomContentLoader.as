package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      public static const const_697:String = "RCL_LOADER_READY";
      ...
      private var var_1065:IEventDispatcher = null;
      
      private var var_1311:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_530 = [];
         var_531 = [];
         var_2134 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2136 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_428 = new Map();
         _events = new Map();
      ...
      {
         if(var_179 != null && var_179.hasWorldType(const_281 + param1))
         {
            return var_179.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_529.add(_loc10_,_loc11_);
                              if(var_530.indexOf(_loc14_) < 0)
                              {
                                 var_530.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_428 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_428.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_428.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_609.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_428.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_351,const_500,ROOM_CONTENT,const_787,const_789];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2134.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_177 && _loc5_ != RoomObjectLogicEnum.const_112)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1144);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2138)
         {
            ...
            if(var_1065 != null)
            {
               var_1065.dispatchEvent(new Event(const_697));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_179 != null)
         {
            return var_179.getWorldHeightScale(const_281 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1065 = param1;
            var_2135 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2133 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2137 = param2.getKey("public.room.dynamic.download.url","");
            var_2132 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_788;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_427 != null)
         {
            var_427.remove(param2);
            var_427.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_177 && _loc5_ != RoomObjectVisualizationEnum.const_112)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1311.getValue(param1) != null)
         {
            var_179 = var_1311.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_412,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_179 != null)
         {
            return var_179.getWorldScale(const_281 + param1);
         }
         return 32;
      }
