package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_790:IAvatarRenderManager = null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_465 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_465.length)
            {
               _loc1_ = var_465.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_790 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectVisualizationEnum.const_1002:
               ...
               break;
            case RoomObjectVisualizationEnum.const_830:
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_465.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_790;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_790;
            }
            if(var_1715)
            {
               var_465.add(param1,_loc6_);
            }
            return _loc6_;
         }
         return null;
