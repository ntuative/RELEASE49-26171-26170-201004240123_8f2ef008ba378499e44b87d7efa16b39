package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1172:int = 360;
      
      private var var_1815:int = 0;
      
      private var var_660:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1172 / 2) % 360 / var_1172;
         if(var_218.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(var_218.getKey(_loc5_)) * var_1172;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_218.getKey(_loc4_));
         }
         return const_1218;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_857);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_840);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_218.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_218 != null)
         {
            ...
            {
               _loc2_ = var_218.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_218.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_218.add(String(_loc7_),_loc3_);
            var_1173 = -1;
            var_660 = null;
            _loc5_++;
         }
