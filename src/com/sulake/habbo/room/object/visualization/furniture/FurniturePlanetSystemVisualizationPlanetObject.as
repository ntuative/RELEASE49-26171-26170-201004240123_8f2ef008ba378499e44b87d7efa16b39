package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private var var_676:Vector3d;
      
      private var var_1305:Number;
      ...
      {
         var_676 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1305 = param3;
         var_1856 = param4 * 0 * 2 / 360;
         var_1454 = param5 * 0 * 2 / 360;
         _height = param6;
         var_819 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1305 * Math.cos(var_819 + var_1454);
         var _loc4_:Number = var_1305 * Math.sin(var_819 + var_1454);
         var _loc5_:Number = _height;
         var_676.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_676.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_676.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_676.add(param1);
         }
