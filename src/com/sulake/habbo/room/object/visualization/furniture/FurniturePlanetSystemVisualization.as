package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1012);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_243 != null)
         {
            ...
            {
               _loc2_ = var_243[_loc3_];
               _loc2_.update(var_630,var_2233,param1);
               _loc3_++;
            }
