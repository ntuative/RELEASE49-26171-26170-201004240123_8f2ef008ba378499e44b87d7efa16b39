package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_512 == 0)
         {
            var_512 = _animationData.getStartFrame(var_1035,param1);
         }
         var_512 += 1;
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_957)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1035,var_512,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1035,_loc6_,_loc5_.activeSequenceOffset + 1,var_512,param1);
               }
