package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = var_204[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         if(!var_1546)
         {
            _loc4_ = param1 / var_425;
            param1 %= var_425;
            if(var_1553 > 0 && _loc4_ >= var_1553)
            {
               param1 = var_425 - 1;
               _loc3_ = true;
            }
            ...
            {
               _loc2_ = var_204[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc2_ = var_204[_loc7_] as AnimationFrameSequenceData;
      ...
      {
         if(param1 < 0 || param1 >= var_204.length)
         {
            return null;
         }
         var _loc4_:AnimationFrameSequenceData = var_204[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
