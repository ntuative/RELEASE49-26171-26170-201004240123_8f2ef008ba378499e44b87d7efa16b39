package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_781:int = 15;
      
      private static const const_1104:int = 2;
      
      private static const const_346:int = 2;
      
      private static const const_780:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1055[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1056[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1055 = new Array();
         var_1055.push(Math.random() * _loc2_ * 1.5);
         var_1055.push(Math.random() * _loc2_ * 1.5);
         var_1058 = new Array();
         var_1058.push(1);
         var_1058.push(-1);
         var_1057 = new Array();
         var_1057.push(const_1104);
         var_1057.push(const_1105);
         var_1056 = new Array();
         var_1056.push(getRandomAmplitudeFactor());
         var_1056.push(getRandomAmplitudeFactor());
      }
