package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1443:String = null;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1443 != null && var_1443.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2286,param1);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_857:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_840:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1861 != param1 || var_1863 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1864 != param1 || var_1862 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2286 = _loc3_.getNumber(RoomObjectVariableEnum.const_202);
            ...
            var_1443 = _loc3_.getString(RoomObjectVariableEnum.const_332);
