package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_511);
         ...
         var _loc13_:int = param2 - var_1301;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_334);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_289 != _loc3_.getUpdateID() || var_213 != param1.scale || var_163 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_432 || var_526 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_526;
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_807);
               _loc6_ = var_731.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_291);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_238) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_238);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_551);
            _loc6_.appendAction(AvatarAction.const_579,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_480);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_316,AvatarAction.const_1362[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_914);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_954,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_977);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_962);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_894,_loc27_);
               }
            }
            ...
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_507);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_814,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_805);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_993,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_479);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_466) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_428);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_956);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_544,_loc32_);
            }
            ...
            var_527 = null;
            _loc35_ = getSprite(const_1658);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_950))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_527 = var_731.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_527 = var_731.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_527 != null)
               {
                  _loc35_.asset = var_527.content as BitmapData;
