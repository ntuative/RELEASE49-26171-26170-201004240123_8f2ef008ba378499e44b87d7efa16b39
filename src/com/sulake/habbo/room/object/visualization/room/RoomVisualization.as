package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_752:int = 16777215;
      
      public static const const_1228:int = 10066329;
      
      private static const const_750:int = 13421772;
      
      public static const const_1292:int = 16777215;
      
      private static const const_1411:int = 0;
      
      public static const const_1176:int = 16777215;
      
      private static const const_751:int = 10066329;
      
      private static const const_749:int = 10066329;
      
      public static const const_1390:int = 13421772;
      ...
      private var var_386:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_386 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_74.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_239)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_827);
         ...
         while(_loc7_ < var_74.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_142)
            {
               ...
               {
                  _loc13_.color = const_749;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_752;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_750;
               }
               else
               {
                  _loc13_.color = const_751;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_239)
            {
               ...
               {
                  _loc13_.color = const_1390;
               }
               else
               {
                  _loc13_.color = const_1228;
               }
               if(_data != null)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_203 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_386.maskCount)
         {
            _loc6_ = var_386.getMaskType(_loc5_);
            _loc7_ = var_386.getMaskLocation(_loc5_);
            _loc8_ = var_386.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_103.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_203 || _loc3_.type == RoomPlane.const_192 && _loc8_ == RoomPlaneBitmapMaskData.const_206)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        if(var_74.getPlaneType(_loc9_) == RoomPlaneData.const_147)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1332)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1081 || _loc9_.y != var_1654 || _loc9_.z != var_1658 || param1.scale != var_1649))
            {
               var_1081 = _loc9_.x;
               var_1654 = _loc9_.y;
               var_1658 = _loc9_.z;
         ...
         if(var_163 != _loc6_.getUpdateID())
         {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_631));
            if(_loc11_ != var_959)
            {
               var_959 = _loc11_;
               var_1656 = var_959 & 255;
               var_1655 = var_959 >> 8 & 255;
               var_1651 = var_959 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1657 + const_1633 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1657 = _loc7_;
         if(var_163 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_654);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_518);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_538);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1653 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_1019));
            var_163 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_385.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_385[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_192)
            {
               if(var_1653)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1656 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1655 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1651 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_103.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_203 && param2 != null)
               {
                  _loc5_.id = param2;
               }
