package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_741:PlaneMaskVisualization = null;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_741 = var_436.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_741 = null;
      ...
      {
         if(var_436.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         var_436.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_436 != null)
         {
            ...
            {
               _loc1_ = var_436.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
