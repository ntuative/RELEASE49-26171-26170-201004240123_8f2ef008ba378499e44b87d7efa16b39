package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_1008;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_239,param1,param2,param3,[param4]);
         ...
         if(param5)
         {
            addPlane(RoomPlaneData.const_142,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_142,Vector3d.sum(param1,Vector3d.product(param3,-var_113 / param3.length)),Vector3d.product(param3,(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      public function method_7(param1:int, param2:int) : Boolean
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 < 0)
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_745 = getFloorHeight(var_102);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            else
            {
               ...
               if(param2 == var_342 || param2 == var_345)
               {
                  _loc7_ = false;
                  _loc8_ = var_344;
