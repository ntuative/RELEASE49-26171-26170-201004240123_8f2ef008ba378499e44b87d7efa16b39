package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1423:int = 1500;
      
      private var var_1422:int = 255;
      
      private var var_1424:int = 255;
      
      private var var_1159:uint = 16777215;
      
      private var var_971:uint = 16777215;
      
      protected var var_74:RoomPlaneParser = null;
      
      private var var_792:int = 0;
      
      private var var_1167:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_582:
                  _loc2_.setString(RoomObjectVariableEnum.const_518,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_640:
                  _loc2_.setString(RoomObjectVariableEnum.const_654,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_367:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_206)
                  {
                     _loc8_ = "null";
                  }
                  var_386.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_622:
                  _loc7_ = var_386.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_386.getXML();
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1019,int(_loc5_.bgOnly));
            var_1159 = _color;
            var_1422 = var_1167;
            var_971 = _loc11_;
            var_1424 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_827,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_631,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1303,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1401,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1314,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_142 || _loc13_ == RoomPlaneData.const_239)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_792)
         {
            ...
            {
               _loc7_ = var_1159 >> 16 & 255;
               _loc8_ = var_1159 >> 8 & 255;
               _loc9_ = var_1159 & 255;
               _loc10_ = var_971 >> 16 & 255;
               _loc11_ = var_971 >> 8 & 255;
               _loc12_ = var_971 & 255;
               _loc13_ = (_loc2_ - var_792) / var_1423;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1422 + (var_1424 - var_1422) * _loc13_;
               _color = _loc3_;
               var_1167 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_631,_loc3_);
         }
      }
   }
}
