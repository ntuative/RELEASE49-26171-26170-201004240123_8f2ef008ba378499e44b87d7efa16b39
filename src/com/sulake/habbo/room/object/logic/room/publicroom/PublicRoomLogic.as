package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_453,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_730,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_453,Number(false));
         var_839 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_919:
                  _loc2_.setString(RoomObjectVariableEnum.const_308,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_730,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_453,Number(true));
                  var_972 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_813);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_411)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_730);
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_411)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_284,_loc5_,_loc6_));
               }
               break;
