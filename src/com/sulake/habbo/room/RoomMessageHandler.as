package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_996:int = -1000000000;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_961,_loc3_.status);
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_967:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_953:
                     _loc10_ = "std";
               }
