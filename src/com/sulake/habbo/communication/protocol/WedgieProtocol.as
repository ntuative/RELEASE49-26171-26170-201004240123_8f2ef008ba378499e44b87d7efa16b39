package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1318:uint = 1;
      
      public static const const_1391:uint = 2;
       
      
      private var var_902:IProtocolDecoder;
      
      private var var_1066:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1066 = new WedgieEncoder();
         var_902 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1318)
            {
               _loc4_.position = 0;
               _loc6_ = var_902.getID(_loc4_);
