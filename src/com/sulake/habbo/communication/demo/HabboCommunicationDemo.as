package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1412:String = "fuselogin";
      
      private var var_294:ICoreCommunicationManager;
      
      private var var_390:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1179:
            case DisconnectReasonEvent.const_1269:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1700)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_654 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_654);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1149,var_1701));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1412,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_390.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_390.getSharedKey(16).toUpperCase();
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1412,"/");
      ...
      {
         var_654 = _habboConfiguration.getKey("sso.ticket",null);
         ...
         if(var_654 != null)
         {
            var_64.mode = HabboConnectionType.const_445;
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_583);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_64.mode)
         {
            case HabboConnectionType.const_445:
               _loc6_ = "";
               ...
               var_968 = _loc4_;
               var_166.loadBannerImage(_loc7_ + "?token=" + var_968,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_841:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1141:
               var_566 = generateRandomHexString(30);
               var_390 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_390.init(var_566);
               _loc8_ = var_390.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_968);
         ...
         var_390 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_390.init(_loc14_);
            _loc15_ = var_390.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_841;
            }
         }
         var_64.initConnection(HabboConnectionType.const_245);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_157,onConfigurationLoaded);
         }
      }
