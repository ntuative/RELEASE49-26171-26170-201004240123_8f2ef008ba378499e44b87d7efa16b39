package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_347.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_347.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_261,onParsedTicketFailure);
         var_115 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1412,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_347.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_373,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1412,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_115 = new SSOTicket(var_347.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_261,onParsedTicketFailure);
      }
