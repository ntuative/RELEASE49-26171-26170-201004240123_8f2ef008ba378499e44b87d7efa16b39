package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      {
         var _loc3_:AssetLoaderStruct = var_765.loadAssetFromFile("hotel_view_banner_" + var_931,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_668));
            }
            var_626 = param2;
