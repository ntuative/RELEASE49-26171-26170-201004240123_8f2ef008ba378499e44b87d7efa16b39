package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1190.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1191.length)
         {
            _loc2_ = var_673.indexOf(var_1191[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_298[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_819 + _loc3_);
                  _loc3_ += var_1189;
               }
            }
            _loc4_++;
            ...
            if(_loc2_ != null)
            {
               if(!containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        var_1190.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "PetVisualizationData");
                        _loc9_++;
                     }
                  }
                  else
                  {
                     var_1190.push(_loc2_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_298[var_673.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1849.elements("menu");
         var _loc5_:int = 0;
