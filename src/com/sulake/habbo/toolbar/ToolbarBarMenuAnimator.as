package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1102:Number = 90;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_204,windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_590[_loc3_] = new Array();
            }
            if(var_590[_loc3_].indexOf(param1) < 0)
            {
               var_590[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_770 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_770 || param1.desktop.height - param1.y < const_1084;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_508.length)
         {
            if(var_508[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_590[_loc3_].length)
                  {
                     repositionWindow(var_590[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
