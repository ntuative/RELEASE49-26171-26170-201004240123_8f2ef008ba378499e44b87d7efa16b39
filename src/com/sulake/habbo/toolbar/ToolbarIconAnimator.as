   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_816.push(new XML());
               var_818.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_818[var_54] = param6.clone();
         }
      ...
      {
         if(var_1192 == true || var_675 == 0)
         {
            if(false)
            {
               ++var_54;
               if(var_54 >= var_816.length)
               {
                  var_54 = 0;
                  ++var_675;
               }
      ...
      {
         return var_816.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1192 == false && var_675 == 1 && var_1249 != var_33;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_54 <= var_818.length)
         {
            _loc2_ = var_818[var_54];
