package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_964,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1004 = String(_loc7_.relocate_by_drag.@state) == "PetVisualizationData";
         if(var_1004)
         {
         ...
         var_1212 = _loc7_.toolbar.@margin_bottom;
         var_1477 = _loc7_.toolbar.@min_group_margin;
         var_1478 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_260,param1,param2,_window,var_276);
         createGroupsFromXmlList(_loc9_,var_577,param1,param2,var_196,var_276);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_129,var_496,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1477,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1212) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1477,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1212) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_577.length)
         {
            _loc3_ = var_577[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_129,var_496);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_577.length)
         {
            _loc2_ = var_577[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_496);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_129,var_496);
         }
      }
