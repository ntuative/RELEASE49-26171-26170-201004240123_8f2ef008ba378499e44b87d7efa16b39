package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_318 && _loc4_.state != FriendRequest.const_333)
            {
      ...
      {
         var_1548 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1547 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1547.procedure = onDismissAllButtonClick;
         var_1548.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1020)
         {
