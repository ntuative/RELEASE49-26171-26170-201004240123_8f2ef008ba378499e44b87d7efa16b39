package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_563 = param1.gender;
         var_712 = param1.online;
         var_1170 = param1.followingAllowed && param1.online;
         var_322 = param1.figure;
         var_1203 = param1.motto;
         var_1202 = param1.lastAccess;
         var_1200 = param1.categoryId;
         var_1201 = param1.realName;
