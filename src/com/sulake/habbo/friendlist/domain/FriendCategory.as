package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_227.length / const_288);
      }
      ...
      {
         if(this.var_849 >= this.getPageCount())
         {
            this.var_849 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_849 + 1) * const_288,this.var_227.length);
      }
