package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_178:String = "face";
      ...
      private var var_1469:OpenedToWebPopup;
      
      private var var_825:IAvatarRenderManager;
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_340.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_340.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_408.findTab(FriendListTab.const_91).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_340 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_90.addCategory(new FriendCategory(FriendCategory.const_969,getText("friendlist.friends")));
         var_90.addCategory(new FriendCategory(FriendCategory.const_459,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_495)
         {
            var_495 = new Timer(120000);
            var_495.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_495.start();
         }
         getBuddyRequests();
         registerListeners();
         var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_495.stop();
            var_495.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_495 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_825)
         {
            var_825.release(new IIDAvatarRenderManager());
            var_825 = null;
         }
         if(var_824)
         {
            var_824.release(new IIDHabboNotifications());
            var_824 = null;
         }
         if(var_193)
         {
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "PetVisualizationData";
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1470.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_340.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ > var_340.limit)
         {
            var_340.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_408.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_825.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_340.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_408.findTab(FriendListTab.const_91);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1469 == null)
         {
            var_1469 = new OpenedToWebPopup(this);
         }
         var_1469.show(x,y);
      }
