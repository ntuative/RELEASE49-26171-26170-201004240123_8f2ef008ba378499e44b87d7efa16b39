package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1441:String = "noconvinfo";
      
      private static const const_1442:String = "messageinput";
      ...
      private var var_1367:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1367 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_808 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_279 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1367.prepare(var_808);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_862,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1304,true);
         var_14.header.setParamFlag(HabboWindowParam.const_558,false);
         var_14.header.setParamFlag(HabboWindowParam.const_821,true);
         var_14.content.setParamFlag(HabboWindowParam.const_558,false);
         ...
         var_1366 = ITextWindow(var_14.findChildByName("info_text"));
         var_1366.text = "";
      ...
      public function openFriendList() : void
      {
         ...
         {
            prepare();
            _friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.FRIENDLIST,var_14));
         }
         else
         {
            var_14.visible = true;
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_1022,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_558,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_862,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1603 = var_14.height;
         var_1602 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1603 == -1 ? 0 : int(0 - var_1603);
         var _loc4_:int = var_1602 == -1 ? 0 : int(0 - var_1602);
