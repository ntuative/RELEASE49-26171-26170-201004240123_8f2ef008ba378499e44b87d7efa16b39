package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1218));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1483[var_1218]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
