package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_685 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_685.procedure = onSearchInput;
         var_685.addEventListener(WindowKeyboardEvent.const_143,onSearchStrInput);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_685.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
