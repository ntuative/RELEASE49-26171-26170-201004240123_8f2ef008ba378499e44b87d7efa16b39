package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1488:IButtonWindow;
      ...
      private var var_1487:IButtonWindow;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1487,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1488,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1487 = IButtonWindow(find("top_tab"));
         var_1488 = IButtonWindow(find("obj_tab"));
         var_1932 = IWindowContainer(find("tile_grid"));
         var_1933 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1487,onTopTabButton);
         Util.setProcDirectly(var_1488,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1932;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_485)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1933;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_42,HabboWindowParam.const_72,new Rectangle(0,0,param1.width,66)));
