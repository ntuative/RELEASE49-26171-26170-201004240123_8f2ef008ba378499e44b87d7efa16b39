package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_796:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_468 = new Timer(100);
         var_468.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_39 = new Array();
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,104,"a"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,94,"b"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,36,"c"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,84,"d"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"e"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,80,"f"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,416,"i"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,320,"j"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,448,"k"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,352,"l"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,384,"m"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_53,372,"n"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,80,"g"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,74,"h"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,416,"o"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,352,"p"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,304,"q"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,336,"r"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,748,"u"));
         var_39.push(new RoomLayout(HabboClubLevelEnum.const_63,438,"v"));
      ...
      private function prepare() : void
      {
         ...
         var_974 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_468)
         {
            var_468.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_468.reset();
            var_468 = null;
         }
      }
      ...
      {
         var_974.goBackToInitialState();
         var_974.input.textBackgroundColor = 4294967295;
         var_796 = var_39[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_42,HabboWindowParam.const_72,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_974.getText();
      ...
      {
         var _loc1_:Boolean = var_974.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_796.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1164 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1164 = true;
            _loc3_.y = 1;
