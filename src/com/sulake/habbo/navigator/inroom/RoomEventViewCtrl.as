package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_694.getText();
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1485.visible = true;
         var_1929.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_694.setText(param1.eventDescription);
         var_834.setText(getTagFromEvent(param1,1));
         var_835.setText(getTagFromEvent(param1,2));
         var_1227.visible = false;
         var_1226.visible = true;
         var_1228.visible = true;
         var_1486.visible = false;
         var_1484.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1485 = IWindowContainer(find("event_type_disabled_cont"));
            var_1929 = ITextWindow(find("event_type_disabled_text"));
            var_1486 = ITextWindow(find("create_caption"));
            var_1484 = ITextWindow(find("edit_caption"));
            var_1227 = IButtonWindow(find("create_button"));
            var_1226 = IButtonWindow(find("edit_button"));
            var_1930 = IButtonWindow(find("cancel_button"));
            var_1228 = IButtonWindow(find("end_button"));
            var_836 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1227,onCreateButtonClick);
            Util.setProcDirectly(var_1226,onEditButtonClick);
            Util.setProcDirectly(var_1228,onEndButtonClick);
            Util.setProcDirectly(var_1930,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_694 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_834 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_694.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
