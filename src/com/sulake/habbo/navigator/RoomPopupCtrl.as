package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1940 = new RoomThumbnailRenderer(param1);
         var_856 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_174,var_111.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_856.refreshTags(_loc1_,var_111.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1940.refreshThumbnail(_loc1_,var_111.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_174,var_111);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_174,!true ? getEventCtg(var_111.categoryId) : getRoomCtg(var_111.categoryId));
         refreshRoomDesc(var_174,var_111);
         refreshExtraCont();
         refreshInfo(var_174,"trading_allowed",var_111.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_207,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
