   ...
   public class IncomingMessages
   {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         else if(_loc2_.roomForward)
         {
            ...
            else if(_loc2_.data.doorMode == RoomSettingsData.const_109 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
