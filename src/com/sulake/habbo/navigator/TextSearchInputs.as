package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_2381:IButtonWindow;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2307 = param2;
         var_685 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_685.getText();
         if(_loc1_ == "")
         {
            return;
         }
         _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_207,_loc1_);
      }
   }
}
