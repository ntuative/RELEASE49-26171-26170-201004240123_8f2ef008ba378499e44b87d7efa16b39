package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_917:RoomCreateViewCtrl;
      
      private var var_1940:RoomThumbnailRenderer;
      ...
      private var var_1090:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_618 = new RoomInfoViewCtrl(this);
         var_917 = new RoomCreateViewCtrl(this);
         var_1940 = new RoomThumbnailRenderer(this);
         var_1090 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_282.startSearch(Tabs.const_215,Tabs.const_320,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_193 != null)
         {
            var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_193.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_282.startSearch(Tabs.const_269,Tabs.const_223);
         var_408.getTab(Tabs.const_269).tabPageDecorator.tabSelected();
      }
