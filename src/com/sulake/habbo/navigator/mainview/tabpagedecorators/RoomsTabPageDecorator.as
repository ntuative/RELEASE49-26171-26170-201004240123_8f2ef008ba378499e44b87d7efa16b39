package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_289);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_525);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_271,Tabs.const_289,"" + _loc3_);
         }
      }
