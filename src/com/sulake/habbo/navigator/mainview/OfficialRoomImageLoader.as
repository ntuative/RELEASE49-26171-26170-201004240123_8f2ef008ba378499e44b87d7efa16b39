package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private var var_726:IBitmapWrapperWindow;
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         Logger.log("IMAGE READY: " + var_889 + ", " + _loc2_);
         setImage();
      }
      ...
      public function startLoad() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(_navigator.assets.hasAsset(var_889))
         {
            setImage();
         }
         else
         {
            ...
            _loc2_ = _navigator.assets.loadAssetFromFile(var_889,_loc1_,"image/gif");
      ...
      {
         var _loc1_:BitmapData = _navigator.getButtonImage(var_889,"");
         var_726.bitmap = _loc1_;
         var_726.width = _loc1_.width;
         var_726.height = _loc1_.height;
