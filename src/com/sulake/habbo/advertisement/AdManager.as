package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_888:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_431,0,0,_loc4_,var_1542,var_887,var_888));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2090 = int(_config.getKey("interstitial.interval","30000"));
         var_2091 = int(_config.getKey("interstitial.show.time","5000"));
         var_1543 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1291 = _loc2_.imageUrl;
         var_1542 = _loc2_.clickUrl;
         if(var_1291 != "" && var_1542 != "")
         {
            _loc3_ = var_1291;
            ...
            _loc4_ = new URLRequest(var_1291);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1292 != "")
         {
            ...
            var_234.start();
            _loc4_ = new URLRequest(var_1292);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_442,0,0,param1.bitmapData,var_2092));
            var_725 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_888 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1543 > 0 && var_1544 >= var_1543)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_725;
         if(_loc1_ > var_2090)
         {
            ++var_1544;
