package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_201 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1968 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_201);
      ...
      public function dispose() : void
      {
         if(var_365 != null)
         {
            var_365.events.removeEventListener(BadgeImageReadyEvent.const_121,onBadgeImageReady);
            var_365 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_698,var_1968);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_698,var_698));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_698,var_698));
         _localizations.registerParameter(param1,"level",var_1619.toString());
         _localizations.registerParameter(param1,"name",var_365.userName);
         _localizations.registerParameter(param1,"realname",var_365.realName);
      }
   }
}
