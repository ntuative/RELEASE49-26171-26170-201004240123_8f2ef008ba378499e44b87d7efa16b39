package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1126:String = "pet_inventory";
      
      private static const const_1120:String = "pixelbalance";
      
      private static const const_1121:String = "credits";
      
      private static const const_1125:String = "inventory";
      
      private static const const_1124:String = "friendlist";
      
      private static const const_1123:String = "selectfurni";
      
      private static const const_1119:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_614:ParkBusDialogManager;
      ...
      private var var_435:HabboNotificationViewManager;
      
      private var var_740:ClubEndingNotification;
      ...
      private var var_739:ClubGiftNotification;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_739 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1253);
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1360);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2149)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_811);
            var_2149 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1126:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_138);
               }
               break;
            case const_1123:
               break;
      ...
      {
         if(param1 != null && this.var_435 != null)
         {
            var_435.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_811,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_839,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_162 || param2.type == WindowEvent.const_602)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_435.isSpaceAvailable() && false)
         {
            var_435.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_614 == null)
         {
            var_614 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_614 != null)
         {
            var_614.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_365);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_365.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_85)
               {
                  _loc9_ = var_365.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = var_365.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1140,_loc5_);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1373)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_740 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_613.events.addEventListener(HabboToolbarEvent.const_88,onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_88)
         {
            ...
            var_435 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_909["styles"],var_909["view"],var_613);
            ...
            registerUpdateReceiver(var_435,1);
            registerUpdateReceiver(this,2);
            var_365.events.addEventListener(BadgeImageReadyEvent.const_121,onBadgeImage);
