package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_364);
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_364);
         }
         if(var_251 == null)
         {
            var_251 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_251 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_251);
            var_251.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_251.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_784 = new NameSuggestionListRenderer(_main);
