package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_415:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1832 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1831 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_665 = new Timer(1000,1);
         var_665.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_809 = new Timer(5000,1);
         var_809.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_113,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1833 = _loc2_.width + const_493 + _loc6_.width + const_1054;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1055,_loc8_.width) + const_493);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_415);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_415);
         }
