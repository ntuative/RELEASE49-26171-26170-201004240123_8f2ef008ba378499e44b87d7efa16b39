package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_651,var_155);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1052,const_1051,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_201 != null)
         {
            _loc6_.caption = var_201;
         }
