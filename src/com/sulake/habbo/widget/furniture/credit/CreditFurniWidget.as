package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_700,var_823);
      ...
      {
         hideInterface();
         var_823 = param1.objectId;
         var_1204 = param1.creditValue;
         showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1204));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_59,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1052,const_1051,2,2),null,0) as IWindowContainer;
