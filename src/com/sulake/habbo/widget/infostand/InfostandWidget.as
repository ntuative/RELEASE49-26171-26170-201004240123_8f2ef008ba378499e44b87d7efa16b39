package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1150:InfoStandPetData;
      
      private var var_133:Timer;
      
      private var var_868:InfoStandFurniView;
      ...
      private const const_1656:int = 3000;
      
      private var var_200:InfoStandUserView;
      
      private var var_453:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_868 = new InfoStandFurniView(this,const_1430);
         var_200 = new InfoStandUserView(this,const_1427);
         var_309 = new InfoStandPetView(this,const_1428);
         var_352 = new InfoStandBotView(this,const_1429);
         var_453 = new InfostandUserData();
         var_447 = new InfostandFurniData();
         var_1150 = new InfoStandPetData();
         var_133 = new Timer(const_1656);
         var_133.addEventListener(TimerEvent.TIMER,onUpdateTimer);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_200.setTags(param1.tags,var_2032);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_230,onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_714,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_684,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_468,var_309.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_230,onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_714,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_684,onBadgeImage);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_43,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_262:
               ...
               {
                  _loc2_ = param1.id == var_453.userRoomId;
                  break;
               }
               if(var_309 != null && false && var_309.window.visible)
               {
                  _loc2_ = param1.id == var_1150.roomIndex;
                  break;
               }
      ...
      {
         var_309.updateEnabledTrainingCommands(param1.id,param1.method_2);
      }
