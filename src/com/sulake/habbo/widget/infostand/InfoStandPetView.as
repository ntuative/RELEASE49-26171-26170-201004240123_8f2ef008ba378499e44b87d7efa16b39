package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1641:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1645:String = "level";
      ...
      private const const_1639:String = "nutrition";
      
      private var var_61:IItemListWindow;
      
      private const const_1642:uint = 3355443;
      
      private var var_238:IBorderWindow;
      
      private const const_1644:int = 158;
      
      private const const_1643:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_167:PetCommandTool;
      
      private const const_1640:uint = 11184810;
      
      private const const_1647:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_238 != null)
         {
            var_105 = var_238.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_105 == null || var_238 == null || var_61 == null)
         {
            return;
         }
         ...
         var_238.height = NaN;
         _window.width = Math.max(var_238.width,var_61.width);
      ...
      private function openTrainView() : void
      {
         if(var_167 == null)
         {
            var_167 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1150.getValue(var_635) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_167.showWindow(true);
            var_167.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1645,param1.level,param1.levelMax);
         updateStateElement(const_1647,param1.experience,param1.experienceMax);
         updateStateElement(const_1646,param1.energy,param1.energyMax);
         updateStateElement(const_1639,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_635 = param1.id;
         var_1150.remove(param1.id);
         var_1150.add(param1.id,param1);
         if(var_167 && var_167.isVisible() && param1.isOwnPet)
         {
            var_167.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_167.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_167 && var_167.getPetId() == var_635)
               {
                  var_167.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_363,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1644,const_1643,false);
