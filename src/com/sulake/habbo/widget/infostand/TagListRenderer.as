package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1654:int = 5;
      
      private const const_1655:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_848 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_848 += param1.height + const_1655;
            return fit(param1);
         }
         param1.offset(_offsetX,var_848);
         _offsetX += param1.width + const_1654;
         return true;
      }
