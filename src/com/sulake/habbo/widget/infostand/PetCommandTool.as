package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_374:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_967:Map;
      
      private const const_1664:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_967 = new Map();
         var_375 = new Timer(const_1664);
         var_375.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_619,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_374 == null)
         {
            ...
            var_374 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_374 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_374.x = 200;
            var_374.procedure = onInfoWindowProcedure;
         }
         else
         {
            var_374.visible = true;
         }
      }
      
      private function onButtonDisableTimeout(param1:TimerEvent) : void
      {
         var _loc2_:Array = var_967.getValue(var_635) as Array;
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_468,var_635));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_742,var_635,var_2252 + " " + _loc6_);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = var_967.getValue(param1) as Array;
         if(_loc6_ == null)
         {
            updateCommandButtonsViewState(new Array());
