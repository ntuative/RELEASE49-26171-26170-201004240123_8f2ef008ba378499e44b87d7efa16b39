package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1424:Number = 10;
      
      private static const const_1423:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1012,var_1014,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1012,var_693,var_1014,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1225 = param1.chatType;
         var_1012 = param1.userId;
         var_693 = param1.userName;
         var_1014 = param1.userCategory;
         _message = param1.text;
         var_1224 = param1.userX;
         var_197 = param1.userImage;
         var_1013 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_197 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_406 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1013 != 0)
            {
               _loc30_ = uint(var_1013 >> 16 & 255);
               _loc31_ = uint(var_1013 >> 8 & 255);
               _loc32_ = uint(var_1013 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1225 == RoomWidgetChatUpdateEvent.const_268)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_693);
            }
            else if(var_1225 == RoomWidgetChatUpdateEvent.const_253)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_693);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_348 + _loc20_.textWidth + const_493;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1012,var_1014,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1012,var_1014,_roomId,_roomCategory,param1);
      }
