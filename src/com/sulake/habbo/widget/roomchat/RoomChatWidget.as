package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1101:int = 6000;
      ...
      private static const const_1100:int = 1;
      ...
      private static const const_498:int = (const_497 + const_350) * const_102 + const_102;
       
      
      private var var_885:Number = 1;
      
      private var _disposed:Boolean = false;
      
      private var var_598:int = 18;
      ...
      private var var_721:Point;
      
      private var var_1541:Number = 0;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_233 = new Array();
         var_721 = new Point();
         var_158 = const_498 + const_280;
         super(param1,param2,param3);
         var_2072 = param5;
         var_37 = param1.createWindow("chat_container","",HabboWindowType.const_59,HabboWindowStyle.const_42,HabboWindowParam.const_43,new Rectangle(0,0,200,var_158 + RoomChatHistoryPulldown.const_77),null,0) as IWindowContainer;
         var_37.background = true;
         var_37.color = 33554431;
         var_37.tags.push("room_widget_chat");
         var_357 = param1.createWindow("chat_contentlist","",HabboWindowType.const_872,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,200,var_158),null,0) as IItemListWindow;
         var_37.addChild(var_357);
         var_134 = param1.createWindow("chat_active_content","",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_72,new Rectangle(0,0,200,var_158),null,0) as IWindowContainer;
         var_357.addListItem(var_134);
         var_26 = new RoomChatHistoryViewer(this,param1,var_37,param2);
         var_2073 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_536,onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_279,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_676,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_598,onRoomViewUpdate);
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_980)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_65.length > const_1100 || historyViewerActive() && false)
         {
            method_3();
         }
         ...
         {
            method_3();
            var_722 = getTimer() + const_778;
         }
         else
         {
            if(false && false)
            {
               var_598 = getItemSpacing(_itemList["-1"],var_65[0]);
            }
            else
            {
               var_598 = const_102;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_721.x) * var_885;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1290 && !historyViewerActive())
         {
            resetArea();
            var_1290 = false;
         }
      ...
      {
         return "chat_" + var_2072.toString() + "_item_" + (var_2074++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_536,onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_279,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_676,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_598,onRoomViewUpdate);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_432)
         {
            _loc2_ = param1 / const_1085 * const_1102;
            if(_loc2_ + var_720 > var_598)
            {
               _loc2_ = var_598 - var_720;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1541 == 0)
            {
               var_1541 = param1.scale;
            }
            else
            {
               var_885 = param1.scale / var_1541;
            }
         }
         if(param1.positionDelta != null)
         {
            var_721.x += param1.positionDelta.x / var_885;
            var_721.y += param1.positionDelta.y / var_885;
         }
         if(param1.rect != null)
         {
            if(var_26 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_2073)
         {
      ...
      private function method_3() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_497 + const_350 + 2)
               {
                  _loc1_.aboveLevels = const_497 + const_350 + 2;
               }
               var_518 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_158 = param1 - 0;
         var_37.height = var_158 + RoomChatHistoryPulldown.const_77;
         if(var_26 != null)
         {
            var_26.containerResized(var_37.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_611,param1,param2,param4,param5);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_350 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1101)
               {
