package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1661:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_764)
         {
            return;
         }
         if(var_764 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_764) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_764 % 2) ? uint(const_1439) : uint(const_1440);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1661;
            var_764 = param1;
         }
      }
