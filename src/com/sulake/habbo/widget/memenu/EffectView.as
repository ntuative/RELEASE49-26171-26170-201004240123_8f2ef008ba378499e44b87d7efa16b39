   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_863 = _window.findChildByName("effect_hilite");
            var_863.visible = false;
         }
         var_862 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_861 = _window.findChildByName("loader_bar");
         if(var_861 != null)
         {
            var_415 = var_861.width;
            var_165.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_862 != null)
         {
            var_862.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_862.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
