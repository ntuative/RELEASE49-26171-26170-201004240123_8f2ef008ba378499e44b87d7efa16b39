package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_878:Number = 55;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_554,param1.effect.type));
         }
         else
         {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "moreEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1018));
               break;
            case "hideEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_522));
               break;
            default:
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            var_570.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_878;
            _loc2_++;
         }
         _loc4_ = 0;
         _loc5_ = 0 * const_878;
