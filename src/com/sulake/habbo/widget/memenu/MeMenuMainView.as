      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_1026);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_888));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_581);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_971));
               _widget.hide();
               break;
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_832));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_520);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "PetVisualizationData";
               if(false && _loc4_)
               {
