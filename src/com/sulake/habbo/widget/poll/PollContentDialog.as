package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.method_1(WindowState.WINDOW_STATE_SELECTED))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_733[var_1062] as Dictionary;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1062;
         if(var_1062 < var_733.length)
         {
            _loc1_ = var_733[var_1062] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_733.length);
                  _loc2_.text = _loc6_;
               }
