package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_938;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_938,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_412,var_77,var_1100);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_938);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_633[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_634[var_211]);
         _catalog.purchaseProductAsGift(var_412,var_77,var_1100,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowKeyboardEvent.const_580:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc4_ != null)
            {
               _loc4_.procedure = method_5;
            }
            _localization.registerParameter("catalog.gift_wrapping.price","price",_loc1_.price.toString());
            var_1530 = _loc1_.stuffTypes;
            var_633 = _loc1_.boxTypes;
            var_634 = _loc1_.ribbonTypes;
            var_938 = var_1530[0];
            _boxIndex = var_633[0];
            var_211 = var_634[0];
            initColorGrid();
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_542 == null)
         {
            var_542 = createWindow("suggestion_list_item") as IWindowContainer;
            var_542.procedure = suggestionsEventHandler;
         }
         if(var_244 == null || var_542 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_244.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_542.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
