package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_1775:MarketplaceItemStats;
      ...
      {
         if(!var_148 || !_catalog || !_catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = var_148.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(param1.furniCategoryId != var_1768 || param1.furniTypeId != var_1772)
         {
            return;
         }
         var_1775 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = var_148.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = var_148.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               var_148.add(parser.offerId,updateItem);
            }
            var_148.remove(parser.requestedOfferId);
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1683 = _loc3_.creditsWaiting;
         var_190 = new Map();
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            var_148.add(_loc4_.offerId,_loc6_);
         }
         if(_visualization == null)
         {
            return;
      ...
      {
         requestOffers(var_1774,var_1769,var_1770,var_1771);
      }
