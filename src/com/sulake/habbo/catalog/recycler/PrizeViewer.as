   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(var_287 != null && true)
         {
            ...
            var_287.bitmap = new BitmapData(var_287.width,var_287.height,true,16777215);
            var_287.bitmap.fillRect(var_287.bitmap.rect,16777215);
            _loc3_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_287.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
      ...
      {
         var _loc8_:* = null;
         var_287 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
