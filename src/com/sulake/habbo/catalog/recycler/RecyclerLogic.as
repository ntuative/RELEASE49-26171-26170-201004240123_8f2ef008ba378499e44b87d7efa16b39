package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1457)
         {
            case RecyclerStatusMessageEvent.const_1345:
               ...
               break;
            case RecyclerStatusMessageEvent.const_970:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1180:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1457 != RecyclerStatusMessageEvent.const_970;
      }
      
      private function get statusActive() : Boolean
      {
         return var_259 != const_763;
      }
      ...
      {
         return active && var_259 == const_347;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_184)
            {
