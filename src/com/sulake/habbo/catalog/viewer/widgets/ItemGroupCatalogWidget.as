package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_604[var_1064] as Array;
      ...
      {
         var _loc2_:Offer = var_604[var_1064][var_2112];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_461 || _loc1_.pricingModel == Offer.const_455)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_85 || _loc3_.productType == ProductTypeEnum.const_80)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1063.indexOf(_loc5_) == -1)
                        {
                           var_1063.push(_loc5_);
                           var_604.push(new Array());
                        }
                        _loc6_ = var_1063.indexOf(_loc5_);
                        (var_604[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_604)
         {
            if(var_2112 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2112] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1064 = var_948.getGridItemIndex(param1.view);
