package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_803:MarketPlaceOfferData;
      ...
      private const const_1414:int = 2;
      ...
      private const const_1651:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_471)
         {
            ...
            var_471 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_471)
         {
            return;
         ...
         updateStatusDisplay(const_1414,_loc2_.length);
         if(!var_398)
         {
            var_398 = new Timer(25);
            var_398.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_802 = 0;
         populateList();
         var_398.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_471 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_471.clone() as IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(var_398)
         {
            var_398.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_398 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_802 >= var_569.length)
            {
               return true;
            }
            addListItem(var_569.getWithIndex(var_802));
            ++var_802;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_803.offerId);
            }
            return;
         }
