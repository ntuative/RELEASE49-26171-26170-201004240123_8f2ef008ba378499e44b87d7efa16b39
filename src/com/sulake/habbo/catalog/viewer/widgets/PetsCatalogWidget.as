package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_387 >= var_293.length)
         {
            return "";
         }
         var petColor:IPetColor = var_293[var_387] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_557[var_1405] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_387 < 0 || var_387 > var_293.length)
         {
            var_387 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_113,onTextWindowEvent);
         var_569 = new Map();
         ...
         var_778 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_293 = [];
         var_557 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_778);
               if(_loc11_)
               {
                  var_557 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_557.length)
         {
            _loc12_ = var_557[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_778,_loc12_.id),getRaceLocalizationKey(var_778,_loc12_.id)));
            _loc6_++;
         }
         var_569.add(var_778,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_913,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_387 >= 0 && var_387 < var_293.length)
         {
            _loc7_ = var_293[var_387] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_557[var_1405] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_778,_loc3_.id,_loc2_,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_316,AvatarAction.const_587);
