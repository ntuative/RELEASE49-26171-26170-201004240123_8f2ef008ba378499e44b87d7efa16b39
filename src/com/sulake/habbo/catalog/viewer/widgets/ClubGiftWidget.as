package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_208)
         {
            var_208 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_208)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_208.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_208.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_208.visible = true;
         var_208.activate();
      }
      ...
      {
         if(!param1 || !param2 || !var_569 || !var_48)
         {
            return;
         }
