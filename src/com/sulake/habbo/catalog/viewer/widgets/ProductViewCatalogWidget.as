package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1126:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1377.text = "${" + _loc3_.name + "}";
            var_1378.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1377.text = "${" + _loc2_.localizationId + "}";
            var_1378.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_376:
                  _loc4_ = var_1125.clone();
                  if(var_554 != null)
                  {
                     var_554.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_554,var_1126,var_1275);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_235:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_316,AvatarAction.const_506);
                              _loc13_.appendAction(AvatarAction.const_544,_loc6_.productClassId);
      ...
      {
         var_1377 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1378 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1402 = new Point(var_81.x,var_81.y);
         var_554 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1126 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_554 == null)
         {
         ...
         var_1125 = _loc2_.content as BitmapData;
