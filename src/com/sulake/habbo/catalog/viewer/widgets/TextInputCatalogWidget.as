package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1096 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1096 != null)
         {
            var_1096.addEventListener(WindowKeyboardEvent.const_580,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1096.text));
      }
   }
}
