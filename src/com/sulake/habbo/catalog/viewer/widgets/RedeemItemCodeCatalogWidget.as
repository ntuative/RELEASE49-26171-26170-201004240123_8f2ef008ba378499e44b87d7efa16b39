package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1073 != null)
         {
            var_1073.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1074 != null)
         {
            var_1074.removeEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1073 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1073 != null)
         {
            var_1073.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1074 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1074 != null)
         {
            var_1074.addEventListener(WindowKeyboardEvent.const_143,windowKeyEventProcessor);
         }
      }
