package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_860:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1397 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1397) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_884);
      }
      ...
      {
         return _localization.getLinks(var_884);
      }
