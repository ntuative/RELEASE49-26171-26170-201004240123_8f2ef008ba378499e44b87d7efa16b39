package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_194:Dictionary = new Dictionary();
      
      private static const const_786:Object = {"frontpage3":[7,8]};
      
      private static const const_1111:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      private static const const_1110:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      
      {
         const_194["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_194["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_194["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_194["collectibles"] = ["ctlg_collectibles_link"];
         const_194["club1"] = ["ctlg_text_5"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_606.length)
         {
            _loc2_ = String(var_606[param1]).replace("#","0x");
