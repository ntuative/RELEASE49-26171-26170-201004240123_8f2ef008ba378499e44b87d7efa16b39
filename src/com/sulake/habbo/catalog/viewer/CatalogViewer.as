package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1491:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_412 != null)
         {
            if(var_412.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_412.window);
            var_412.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1491);
         var_412 = _loc5_;
      ...
      {
         return var_412.dispatchWidgetEvent(param1);
      }
