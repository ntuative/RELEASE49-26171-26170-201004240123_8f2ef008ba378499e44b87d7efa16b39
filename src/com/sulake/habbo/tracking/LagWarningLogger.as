package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1215 || var_1569 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1568 == 0 || _loc1_ - var_1568 > var_1569)
         {
            if(_connection != null)
            {
      ...
      {
         var_1215 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1569 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
