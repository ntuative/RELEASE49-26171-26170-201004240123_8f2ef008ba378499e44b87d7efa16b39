package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_232:PerformanceTracker = null;
      ...
      private var var_878:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_232 = new PerformanceTracker();
         var_231 = new LatencyTracker();
         var_878 = new LagWarningLogger();
         var_1282 = new Array(const_776);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1298,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1242,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1367,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_727,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_817,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1347);
               break;
            case HabboCommunicationEvent.const_583:
               trackLoginStep(HabboLoginTrackingStep.const_1195,String(_communication.port));
               break;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_157)
         {
            Component(var_157).events.addEventListener(HabboConfigurationEvent.const_157,onConfigurationLoaded);
            if(var_231 != null)
            {
               var_231.configuration = var_157;
            }
            if(var_232 != null)
            {
               var_232.configuration = var_157;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_249.events.addEventListener(AdEvent.const_431,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_817,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_727,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_583,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_668,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_408:
               var_878.warpingDetected();
         }
      }
         ...
         if(!disposed)
         {
            ...
            if(var_177)
            {
               if(true)
               {
                  ...
                  Component(var_177).events.removeEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_408,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_157)
         {
            if(var_878 != null)
            {
               var_878.configure(var_157);
            }
            Component(var_157).events.removeEventListener(HabboConfigurationEvent.const_157,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_887);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_887,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1044 > -1 && _loc2_ < var_1044)
         {
            ++var_1533;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1533);
         }
         if(var_1044 > -1 && _loc2_ - var_1044 > 15000)
         {
            ++var_1534;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1534);
         }
         var_1044 = _loc2_;
         if(var_232 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_408,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_177).events.addEventListener(HabboFriendListTrackingEvent.const_315,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_157)
            {
               if(var_157.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_232 != null)
                  {
                     _loc4_["null"] = var_232.flashVersion;
                     _loc4_["null"] = var_232.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_668)
         {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1187);
         }
      }
   }
}
