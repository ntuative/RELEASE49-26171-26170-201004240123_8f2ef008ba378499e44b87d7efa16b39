package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1118:String = "Default";
      ...
      private var var_322:AvatarFigureContainer;
      ...
      private var var_180:IActiveActionData;
      
      private var var_55:AvatarStructure;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         var_322 = new AvatarFigureContainer(param3);
         if(param6)
         {
            _loc7_ = var_55.getMandatorySetTypeIds();
            if(_loc7_)
            {
               _loc8_ = var_55.figureData;
               for each(_loc9_ in _loc7_)
               {
                  if(!var_322.hasPartType(_loc9_))
                  {
                     _loc10_ = var_55.getDefaultPartSet(_loc9_,param6);
                     if(_loc10_)
                     {
                        var_322.updatePart(_loc9_,_loc10_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc11_ = _loc8_.getSetType(_loc9_);
                     _loc12_ = _loc11_.getPartSet(var_322.getPartSetId(_loc9_));
                     if(!_loc12_)
                     {
                        _loc13_ = var_55.getDefaultPartSet(_loc9_,param6);
                        var_322.updatePart(_loc9_,_loc13_.id,[0]);
                     }
                  }
               }
            }
         ...
         {
            _loc14_ = var_322.getPartSetId("pbd");
            solvePetAvatarTypeAndBreed(_loc14_);
            var_1314 = var_1067;
         }
         var_135 = new AvatarImageCache(var_55,this,_assets,var_205);
         setDirection(const_1117,const_1115);
         var_206 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1313;
         if(param2 < AvatarDirectionAngle.const_1378)
         {
         ...
         if(var_716 == AvatarType.PET && param1 == AvatarSetType.const_51)
         {
            if((var_94 == 6 || var_94 == 0) && param2 == 7)
            {
               param2 = var_94;
            }
            _loc3_ = var_55.renderManager.petDataManager.getPetData(var_1314);
            if(_loc3_ != null)
            {
         ...
         if(var_55.isMainAvatarSet(param1))
         {
            var_94 = param2;
         }
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_432 = false;
         var _loc1_:Array = var_55.sortActions(var_206);
         if(_loc1_ == null)
         {
         ...
         {
            var_610 = var_55.getCanvasOffsets(_loc1_,var_205,var_94);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            {
               var_432 = true;
               _loc3_ = var_55.getAnimation(_loc2_.definition.state + "." + _loc2_.actionParameter);
               if(_loc3_ != null)
               {
                  var_176 = var_176.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1313 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_532 = _loc3_.avatarData;
                  }
               }
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_428)
            {
               var_432 = true;
            }
            if(_loc2_.actionType == AvatarAction.const_479)
            {
               var_432 = true;
            }
         }
      ...
      {
         return var_55.getPartColor(var_322,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_55.getCanvas(var_205,var_180.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_55.getBodyParts(param1,var_180.definition,var_94);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_512);
            if(_loc10_ != null)
            {
               ...
               if(var_716 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_55.getParts(_loc9_,var_322,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  ...
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_512);
                     _loc21_ = var_94;
                     _loc22_ = 1;
                     switch(var_94)
                     {
                     ...
                     _loc23_ = var_55.getPartActionOffset(getSubType(),var_205,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_55.getCanvas(var_205,var_180.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_55.getCanvas(var_205,var_180.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,var_512);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_716 == AvatarType.PET)
               {
                  ...
                  _loc15_ = var_55.getParts(_loc8_,var_322,_loc13_,"pet",_loc12_.getDirection(),[]);
                  _loc16_ = var_1314 < 3;
                  ...
                  {
                     _loc18_ = _loc15_[0];
                     _loc19_ = _loc18_.getFrameIndex(var_512);
                     _loc20_ = var_94;
                     _loc21_ = 1;
                     switch(var_94)
                     {
                     ...
                     _loc22_ = var_55.getPartActionOffset(getSubType(),var_205,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
         ...
         if(var_532 != null)
         {
            if(false)
            {
               ...
               _image = _loc23_;
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_532.reds,[],[]);
            }
            else
            {
      ...
      private function solvePetAvatarTypeAndBreed(param1:int) : void
      {
         ...
         var_1067 = 0;
         var_1315 = 0;
         var _loc2_:ISetType = var_55.figureData.getSetType("pbd");
         if(_loc2_ != null)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_532 = null;
         var_1313 = 0;
         var_55.removeDynamicItems();
         var_180 = new ActiveActionData(AvatarAction.const_1014);
         var_180.definition = var_55.getActionDefinition(const_1118);
         setActionToParts(var_180);
         getCache().resetBodyPartCache(var_180);
         return true;
      }
      
      public function updateAnimation(param1:Number) : void
      {
         var_512 = int(param1 % const_1116);
         var_321 = true;
      }
      ...
      {
         return var_55.getBodyPartData(param1.animation.id,var_512,param1.id);
      }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            ...
            case AvatarAction.const_993:
               _loc4_ = var_55.getActionDefinitionWithState(param1);
               if(_loc4_ != null)
               {
