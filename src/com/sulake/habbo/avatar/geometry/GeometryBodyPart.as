package com.sulake.habbo.avatar.geometry
{
   ...
   public class GeometryBodyPart extends Node3D
   {
      ...
      public function GeometryBodyPart(param1:XML)
      {
         ...
         var_1305 = parseFloat(param1.@radius);
         _id = String(param1.@id);
         var_168 = new Dictionary();
         for each(_loc2_ in param1..item)
         {
            _loc3_ = new GeometryItem(_loc2_);
            var_168[String(_loc2_.@id)] = _loc3_;
         }
      }
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1305);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1305);
         return Math.min(_loc2_,_loc3_);
      }
      
      public function hasPart(param1:String) : Boolean
      {
         var _loc2_:GeometryItem = var_168[param1];
         return _loc2_ != null;
      }
