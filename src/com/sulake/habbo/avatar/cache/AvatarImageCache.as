package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_807:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_55.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_55.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_642)
                  {
                     if(_loc18_.action != null)
                     {
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_55.getParts(param1,(var_807 as AvatarImage).getFigure(),_loc6_,var_1303,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_55.getCanvas(var_205,var_1303);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            else
            {
               ...
               {
                  _loc31_ = var_55.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc29_ == AvatarAction.const_982 || _loc29_ == AvatarAction.const_545) && (_loc6_ == AvatarBodyPartType.const_330 || _loc6_ == AvatarBodyPartType.const_1152 || _loc6_ == AvatarBodyPartType.const_1266) && _loc7_.color != null)
               {
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_55.getActiveBodyPartIds(param1);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_55.getBodyPartsUnordered(param1);
