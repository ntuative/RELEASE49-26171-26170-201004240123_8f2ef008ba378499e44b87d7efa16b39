package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2060:PartOffsetData;
      
      private var var_880:AvatarActionManager;
      
      private var var_178:IAssetLibrary;
      
      private var var_1045:IAssetLibrary;
      
      private var var_2061:AvatarRenderManager;
      ...
      private var var_1535:AvatarStructureDownloadSet;
      
      private var var_1283:Array;
      
      private var var_717:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_1535 = new AvatarStructureDownloadSet();
         var_717 = new AnimationManager();
         var_716 = param4;
         var_2060 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_717.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1268[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_717.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_716)
         {
            case AvatarType.const_81:
               ...
               var_1535.add(new AvatarStructureDownload(var_178,_loc5_,var_313));
               break;
            case AvatarType.PET:
         }
         var_1535.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_717.getAnimation(param1);
      }
      ...
      {
         var_880 = new AvatarActionManager(var_178,var_716);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1045.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1045.getAssetByName("dance" + _loc1_).content as XML;
            var_717.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1045.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1045.getAssetByName("fx" + _loc1_).content as XML;
            var_717.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
