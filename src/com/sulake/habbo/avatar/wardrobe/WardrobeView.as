package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_771:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_771 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1105 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_771)
         {
            var_771.removeListItems();
         }
         if(var_1105)
         {
            var_1105.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_771)
               {
                  var_771.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1105)
            {
               var_1105.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
