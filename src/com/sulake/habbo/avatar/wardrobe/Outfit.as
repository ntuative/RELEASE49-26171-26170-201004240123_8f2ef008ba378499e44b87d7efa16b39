package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = var_48.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_563);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_40,int(FigureData.const_674));
