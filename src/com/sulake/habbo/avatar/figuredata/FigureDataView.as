package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_334:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_973 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_334 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_334 && var_973)
         {
            var_334.bitmap = new BitmapData(var_334.width,var_334.height,true,16777215);
            var_334.bitmap.copyPixels(var_973,var_973.rect,new Point(0,0 - 0 - 8));
            var_334.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
