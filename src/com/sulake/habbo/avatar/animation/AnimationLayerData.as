package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_642:String = "bodypart";
      ...
      private var var_1587:IActiveActionData;
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         var_2211 = parseInt(param2.@frame);
         _dx = parseInt(param2.@dx);
         var_1156 = parseInt(param2.@dy);
         var_1157 = parseInt(param2.@dz);
         var_1313 = parseInt(param2.@dd);
         _type = param3;
         ...
         if(param5 != null)
         {
            var_1587 = new ActiveActionData(param5.state,_loc7_);
            var_1587.definition = param5;
         }
      }
