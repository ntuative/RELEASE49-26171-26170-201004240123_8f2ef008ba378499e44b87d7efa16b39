package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1493,var_1495,var_1494,_alphaMultiplier);
         var_1094 = generatePaletteMapForGrayscale(var_2219,var_2220);
      }
      
      public function get reds() : Array
      {
         return var_1094.getValue("reds") as Array;
      }
      ...
      {
         return var_1094.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1094.getValue("greens") as Array;
      }
      ...
      {
         return var_1094.getValue("alphas") as Array;
      }
