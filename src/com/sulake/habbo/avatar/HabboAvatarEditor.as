package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_782:AvatarEditorHandler;
      ...
      private const const_1039:int = 2;
      
      private var _catalog:IHabboCatalog;
      
      private var var_11:IHabboInventory;
      
      private var var_563:String = "M";
      
      private var var_157:IHabboConfigurationManager;
      
      private var var_651:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_651.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_164)
         {
            ...
            var_462["null"] = new FigureData(this);
            var_462["null"] = new FigureData(this);
            _loc1_ = var_462["null"];
            _loc2_ = var_462["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_87);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_93);
            var_90 = new Map();
            var_389 = new Map();
            var_90.add(AvatarEditorFigureCategory.const_869,new BodyModel(this));
            var_90.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            var_90.add(AvatarEditorFigureCategory.const_330,new TorsoModel(this));
            var_90.add(AvatarEditorFigureCategory.const_1289,new LegsModel(this));
            var_90.add(AvatarEditorFigureCategory.const_1316,new HotLooksModel(this));
            var_389.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_389.add(AvatarEditorSideCategory.const_382,new ClubPromoModel(this));
            var_164 = true;
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_960 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1407;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_960 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1039)
                  {
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1256)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_960 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_389.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_782 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_651.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_389.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_42,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_869);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_651 = _avatarRenderManager.getFigureData(AvatarType.const_81);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_960 = param3;
         var _loc4_:FigureData = var_462[param2];
         if(_loc4_ == null)
         {
            return;
         }
