package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1440 = new Dictionary();
         super();
         _id = String(param1.@id);
         var_33 = String(param1.@state);
         var_1787 = parseInt(param1.@precedence);
         var_1786 = String(param1.@activepartset);
         var_1783 = String(param1.@assetpartdefinition);
         var_1782 = String(param1.@lay);
         var_1303 = String(param1.@geometrytype);
         var_1784 = Boolean(parseInt(param1.@main));
         var_1781 = Boolean(parseInt(param1.@var_1930));
         var_1780 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1153 = _loc2_.split(",");
         }
      ...
      {
         return var_1153.concat(getTypePrevents(param1));
      }
