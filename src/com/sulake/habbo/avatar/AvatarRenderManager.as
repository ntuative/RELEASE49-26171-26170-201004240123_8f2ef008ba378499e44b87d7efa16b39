package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_986:PaletteManager;
      
      private var var_663:PetDataManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_81:
               _loc3_ = var_220.getValue(AvatarType.const_81) as AvatarStructure;
               break;
            case AvatarType.PET:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_220.getValue(AvatarType.const_81) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_663 = new PetDataManager(_loc1_,_loc3_);
         var_986 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_663.populateFigureData(_loc4_);
         ...
         var_220.add(AvatarType.const_81,_loc5_);
      ...
      {
         return var_663 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_759 = param1;
         if(var_759 == RenderMode.const_1147)
         {
            init();
         }
         if(var_759 == RenderMode.const_1146)
         {
            init();
      ...
      {
         var _loc5_:String = var_663.createAvatarFigureString(param1,param2,param3);
      ...
      {
         var _loc4_:AvatarStructure = var_220.getValue(AvatarType.const_81) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc4_,_aliasCollection,param1,param2,AvatarType.const_81,param3);
      }
