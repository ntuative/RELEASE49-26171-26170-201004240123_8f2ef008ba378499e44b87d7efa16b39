   ...
   public class AvatarEditorGridPartItem
   {
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1549 = Math.max(var_1549,_loc6_.colorLayerIndex);
            }
         }
            ...
            if(var_603)
            {
               switch(var_603.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_55:
                     _loc2_.style = HabboIconType.const_515;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_917 + "_" + FigureData.const_252;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_424.width,var_424.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_917 + "_" + FigureData.const_252;
