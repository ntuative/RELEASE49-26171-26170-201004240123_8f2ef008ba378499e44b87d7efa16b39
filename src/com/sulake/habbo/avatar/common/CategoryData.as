package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_659 >= 0 && var_168.length > var_659)
         {
            _loc2_ = var_168[var_659];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_168.length > param1)
         {
            _loc3_ = var_168[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      {
         return var_168[var_659] as AvatarEditorGridPartItem;
      }
