package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_671:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_813.width,var_813.height,true,0);
            _loc5_ = var_813.clone();
            _loc5_.colorTransform(_loc5_.rect,var_671.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_669.width,var_669.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_669,var_669.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(var_671)
            {
               switch(var_671.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_55:
                     _loc4_.style = HabboIconType.const_515;
                     _loc4_.visible = true;
               }
            }
            else
