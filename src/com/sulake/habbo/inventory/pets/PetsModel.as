package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1207 && param1.type == RoomEngineObjectEvent.const_213)
         {
            var_48.showView();
            var_1207 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1207 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_311,_loc3_.figure);
            var_48.closeView();
            return;
         }
      ...
      {
         if(var_1000.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
