package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_919:IRoomSession;
      ...
      private const const_1660:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_463,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_103:
               var_919 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_463:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      public function canUserOfferToTrade() : Boolean
      {
         ...
         return !!_loc1_ ? Boolean(_loc1_.method_9) : false;
      }
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_607));
      }
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_138));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1660);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_324));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_918.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_918.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_273));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_365 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_918.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_47.getValue(InventoryCategory.const_337) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1078 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_247));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_463,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_337,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_365);
         var_47.add(InventoryCategory.const_247,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_607,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_365);
         var_47.add(InventoryCategory.const_324,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_273,_loc8_);
         ...
         var_47.add(InventoryCategory.const_138,_loc10_);
