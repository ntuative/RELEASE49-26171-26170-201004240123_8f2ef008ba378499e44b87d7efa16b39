package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_748:uint = 4284532064;
      
      private static const const_747:uint = 2577770;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_22.state)
                  {
                     case TradingModel.const_154:
                        if(var_22.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_1017);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_910)
            {
            ...
            var_333.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_436);
            var_333.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1400 == null)
         {
            var_1400 = createMinimizedWindow();
         }
         if(!var_1628)
         {
            return var_62;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_62)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_748) : uint(const_747);
            }
