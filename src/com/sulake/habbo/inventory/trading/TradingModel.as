package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_302:uint = 2;
      
      public static const const_439:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_256:uint = 3;
      
      public static const const_154:uint = 1;
      
      public static const const_179:uint = 0;
      
      public static const const_1349:uint = 9;
      
      public static const const_227:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_498 = false;
         var_690 = false;
         var_46.updateItemList(var_691);
         var_46.updateItemList(var_1214);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_46.alertPopup(TradingView.const_844);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_691)
            {
               var_498 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_690 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_46.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_691)
            {
               var_46.alertPopup(TradingView.const_824);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_498 + " OTHER: " + var_690);
         ...
         {
            case const_179:
               if(param1 == const_154 || param1 == const_227)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_46.setMinimized(param1 != InventoryCategory.const_78);
      ...
      public function close() : void
      {
         if(var_568)
         {
            if(var_33 != const_179 && var_33 != const_227)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_179;
            var_11.toggleInventorySubPage(InventorySubCategory.const_818);
            var_568 = false;
         }
         var_46.setMinimized(false);
      }
