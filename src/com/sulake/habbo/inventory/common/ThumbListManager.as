package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1060:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_602 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_602.width;
         var_93 = var_602.height;
         var_1059 = param5;
         var_893 = param6;
         var_237 = Math.floor(var_1059 / _thumbWidth);
         var_19 = new BitmapData(var_1059,var_893);
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_602.width,var_602.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_602.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_602,var_602.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1060 != null)
         {
            _loc1_ = var_1060.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_237 * _thumbWidth,var_1059),Math.max(var_521 * var_93,var_893),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_237 && var_19.height < _loc3_.y * var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_237 - 1),var_93);
         ...
         _loc4_ = new Rectangle(0,var_93,_thumbWidth * (var_237 - 1),0 - var_93);
