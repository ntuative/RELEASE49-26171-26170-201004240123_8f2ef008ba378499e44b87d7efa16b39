package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_607);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_337))
         {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_138);
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_247);
      }
