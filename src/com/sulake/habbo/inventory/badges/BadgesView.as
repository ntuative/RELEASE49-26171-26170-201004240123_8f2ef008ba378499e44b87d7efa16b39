package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_989:IItemGridWindow;
      ...
      private var var_988:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_988 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_988.procedure = inactiveGridEventProc;
         var_989 = _view.findChildByName("active_items") as IItemGridWindow;
         var_989.procedure = activeGridEventProc;
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_989.getGridItemIndex(param1.window);
      ...
      private function updateListViews() : void
      {
         ...
         var_988.removeGridItems();
         var_989.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_988.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            var_989.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_988.getGridItemIndex(param1.window);
