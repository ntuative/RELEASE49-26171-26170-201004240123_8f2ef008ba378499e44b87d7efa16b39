package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_213,onObjectPlaced);
         var_540 = new Timer(const_1136,1);
         var_540.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_48.getSubCategoryViewId() == InventorySubCategory.const_273;
      }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_213,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_540 != null)
            {
               var_540.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_540.stop();
               var_540 = null;
            }
            if(var_142 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_767 == null)
         {
            var_767 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_767.clone() as IWindowContainer;
      ...
      {
         var_48.checkCategoryInitilization(InventoryCategory.const_337);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_344:
                  var_48.toggleInventoryPage(InventoryCategory.const_138);
            }
         }
      }
      ...
      {
         if(var_935 && param1.type == RoomEngineObjectEvent.const_213)
         {
            var_48.showView();
            var_935 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_338 || _loc3_.category == FurniCategory.const_317 || _loc3_.category == FurniCategory.const_300)
         {
            if(param1)
            {
               return false;
      ...
      public function clearFurniList() : void
      {
         ...
         var_447.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
