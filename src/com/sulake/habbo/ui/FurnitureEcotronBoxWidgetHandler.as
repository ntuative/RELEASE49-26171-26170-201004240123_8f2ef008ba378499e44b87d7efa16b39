package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_532,RoomWidgetEcotronBoxOpenMessage.const_651,RoomWidgetEcotronBoxOpenedMessage.const_1203];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_532:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_651:
