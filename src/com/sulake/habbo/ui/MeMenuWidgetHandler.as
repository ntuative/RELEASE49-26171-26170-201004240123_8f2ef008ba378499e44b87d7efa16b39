   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_940,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_176,onCreditBalance);
         }
         ...
         if(var_11 != null)
         {
            ...
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_836,onHabboClubSubscriptionChanged);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_422:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_452));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_555);
         _loc1_.push(RoomWidgetDanceMessage.const_724);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_715);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_732);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_695);
         _loc1_.push(RoomWidgetStopEffectMessage.const_650);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1370);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_819);
         _loc1_.push(RoomWidgetToolbarMessage.const_589);
         _loc1_.push(RoomWidgetToolbarMessage.const_592);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_728);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1377);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_833);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_530);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_649);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_599);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1288);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_630);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_524);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_509);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_701));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_649:
               ...
               break;
            case RoomWidgetWaveMessage.const_555:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_724:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_715:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_554:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_695:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_832)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_196,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_732:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1018:
                        _catalog.openCatalogPage(CatalogPageName.const_1293,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_971:
                        var_11.toggleInventoryPage(InventoryCategory.const_247);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1301:
                        var_11.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1192:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_650:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_930:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_819:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_530:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_589:
               ...
               if(var_193)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_592:
               ...
               if(var_193 && false)
               {
                  var_193.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_458,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_728:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_599:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_343,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_630:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_343,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_524:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_343,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_509:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_359));
               }
               break;
            default:
