package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_720:int = -1;
      ...
      private var var_777:IRoomWidgetFactory = null;
      ...
      private var var_1868:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_371,onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         {
            var_677 = _roomEngine.loadRoomResources(var_36.roomResources);
            if(false)
            {
               var_1197 = false;
         ...
         {
            var_1196 = !var_249.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_36.roomId,var_36.roomCategory,var_258[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_371,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1868);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_193 != null)
         {
            var_173.toolbarSize = var_193.size;
            var_173.toolbarOrientation = var_193.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_258[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_777.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_585:
               ...
               if(var_649 != null && _loc3_ == RoomObjectCategoryEnum.const_38)
               {
                  _loc7_ = var_36.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_292)
                  {
                     var_649.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_241:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_110:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_590,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_637);
            _loc13_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_584);
            _loc14_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_508);
            _loc15_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_679);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_332);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_407:
               ...
               var_172 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_296,WindowStyle.const_286,WindowParam.const_92) as IToolTipWindow;
               var_172.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_18 != null && var_36 != null && var_1196 && var_1197)
         {
