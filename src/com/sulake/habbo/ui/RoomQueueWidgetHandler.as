package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_454:
               ...
               {
                  case RoomSessionQueueEvent.const_800:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_915) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_915) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1359) + 1;
                  }
               }
               else
               {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_568);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_568:
            ...
            case RoomWidgetRoomQueueMessage.const_660:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_800);
               break;
            case RoomWidgetRoomQueueMessage.const_595:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_196,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_454];
      }
