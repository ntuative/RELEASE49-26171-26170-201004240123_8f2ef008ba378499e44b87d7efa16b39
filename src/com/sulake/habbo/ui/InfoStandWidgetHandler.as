package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_714);
               _loc6_.id = param1.id;
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_933);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_224)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_666);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1165;
                  if(!_loc25_)
                  {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_592.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_592.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_363);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_270);
         _loc1_.push(RoomWidgetFurniActionMessage.const_516);
         _loc1_.push(RoomWidgetFurniActionMessage.const_510);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_617);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_513);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1270);
         _loc1_.push(RoomWidgetPetCommandMessage.const_742);
         _loc1_.push(RoomWidgetPetCommandMessage.const_619);
      ...
      private function onPetCommands(param1:RoomSessionPetCommandsUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            _loc2_ = new RoomWidgetPetCommandsUpdateEvent(param1.petId,param1.method_2);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_416)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_613:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_820,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_540:
               ...
               break;
            case RoomWidgetUserActionMessage.const_363:
            ...
            case RoomWidgetRoomTagSearchMessage.const_617:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_513:
