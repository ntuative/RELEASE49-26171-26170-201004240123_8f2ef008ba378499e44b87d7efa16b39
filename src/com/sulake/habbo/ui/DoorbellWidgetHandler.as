package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionDoorbellEvent.const_136:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_136,_loc2_.userName));
               break;
      ...
      {
         return [RoomSessionDoorbellEvent.const_104,RoomSessionDoorbellEvent.const_136,RoomSessionDoorbellEvent.const_58];
      }
