package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1817:Number = -10000000;
      
      private var var_1819:Number = -10000000;
      
      private var var_2362:int = 0;
      
      private var var_477:RoomObjectCache;
      
      private var var_661:int;
      
      private var var_254:Sprite;
      
      private var var_983:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_984 == 0)
         {
            checkMouseHits(var_985.x,var_985.y,MouseEvent.MOUSE_MOVE);
         }
         var_984 = 0;
         ++var_1447;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_51.graphics.beginFill(var_2362);
      ...
      {
         var _loc11_:Number = param1 - var_661 / 2;
         var _loc12_:Number = param2 - var_662 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_661 != var_1818 || var_662 != var_1816)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_400.sortOn("z",0 | 0);
         if(_loc6_ < var_400.length)
         {
            var_400.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_400[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_804.push(_loc12_ - _loc2_);
         if(var_804.length == const_760)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_760)
            {
               _loc13_ += var_804[_loc14_];
               _loc14_++;
            }
            var_804 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_297 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_297.getKey(_loc1_);
            _loc3_ = var_297.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_983 != null)
                  {
                     var_983.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1447,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_400.length)
         {
            return null;
         }
         return var_400[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_476.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_476.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1817 || param2 != var_1819)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_476.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_476.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_477.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_477.getObjectCache(param2);
         ...
         _loc12_ += int(var_661 / 2);
         _loc13_ += int(var_662 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_661 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_662))
                  {
