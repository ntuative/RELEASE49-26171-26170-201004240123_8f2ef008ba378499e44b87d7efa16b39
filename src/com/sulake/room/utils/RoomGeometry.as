package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1435 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_393 != param1 * var_1435)
         {
            var_393 = param1 * var_1435;
            ++var_75;
         }
      }
      ...
      {
         if(var_395 != param1 * var_1437)
         {
            var_395 = param1 * var_1437;
            ++var_75;
         }
      }
      ...
      {
         if(var_392 != param1 * var_1436)
         {
            var_392 = param1 * var_1436;
            ++var_75;
         }
      }
      ...
      {
         return new Vector3d(0 * var_395,0 * var_392,0 * var_393);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_395,0 * var_392,0 * var_393);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_395,param2.y * var_392,param2.z * var_393);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_395,param3.y * var_392,param3.z * var_393);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_395,param4.y * var_392,param4.z * var_393);
