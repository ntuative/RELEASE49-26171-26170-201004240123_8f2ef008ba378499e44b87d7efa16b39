package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_1338:int = 6;
      
      private static var var_1070:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      
      public static const const_1287:int = 0;
      ...
      private var var_1563:String = "2.0";
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_743 = ChecksumUtil.CRC32(var_20);
            var_534 = false;
         }
         compress();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1320 << 8 | 20);
         }
         else
         {
         ...
         param1.writeShort(var_1320 << 8 | 20);
         param1.writeShort(var_366 == "utf-8" ? 2048 : 0);
         ...
         param1.writeUnsignedInt(var_743);
         param1.writeUnsignedInt(var_182);
         param1.writeUnsignedInt(var_615);
         ...
         {
            _loc8_.writeMultiByte(var_438,var_366);
         }
         ...
         if(param2)
         {
            if(!var_534)
            {
               ...
               var_910 = ChecksumUtil.Adler32(var_20,0,var_20.length);
               var_534 = true;
               if(_loc16_)
               {
                  compress();
         ...
         if(param3 && false)
         {
            if(var_366 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_2163);
            }
            else
            {
               _loc8_.writeMultiByte(var_2163,var_366);
            }
         }
      ...
      {
         if(param1.bytesAvailable >= var_1071 + var_1321)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_366 == "utf-8")
         {
            var_438 = param1.readUTFBytes(var_1071);
         }
         else
         {
            var_438 = param1.readMultiByte(var_1071,var_366);
         }
         var _loc2_:uint = var_1321;
         while(_loc2_ > 4)
         {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1320 = _loc2_ >> 8;
         var_1563 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_744 = param1.readUnsignedShort();
         var_1564 = (_loc3_ & 1) !== 0;
         var_1565 = (_loc3_ & 8) !== 0;
         var_2161 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_366 = "utf-8";
         }
         if(var_744 === const_1338)
         {
         ...
         var_743 = param1.readUnsignedInt();
         var_182 = param1.readUnsignedInt();
         var_615 = param1.readUnsignedInt();
         var_1071 = param1.readUnsignedShort();
         var_1321 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_438 + "\n  date:" + var_742 + "\n  sizeCompressed:" + var_182 + "\n  sizeUncompressed:" + var_615 + "\n  versionHost:" + var_1320 + "\n  versionNumber:" + var_1563 + "\n  compressionMethod:" + var_744 + "\n  encrypted:" + var_1564 + "\n  hasDataDescriptor:" + var_1565 + "\n  hasCompressedPatchedData:" + var_2161 + "\n  filenameEncoding:" + var_366 + "\n  crc32:" + var_743.toString(16) + "\n  adler32:" + var_910.toString(16);
      }
