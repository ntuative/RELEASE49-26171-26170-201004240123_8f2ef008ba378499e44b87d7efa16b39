   ...
   public class HabboMain extends Sprite
   {
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_884,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_28);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_884,error);
            Core.dispose();
         }
      }
